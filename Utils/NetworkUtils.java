...
public final class NetworkUtils {
    ...
    public static List<ReviewsEntry> fetchReviewData(String requestUrl) {
        List<ReviewsEntry> reviews;
    ...
    private static List<ReviewsEntry> parseJsonReviews(String jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                reviewsList.add(new ReviewsEntry(reviewAuthor,reviewText));
            }
